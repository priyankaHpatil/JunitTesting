...
public class ContactManagerTest {
    ...
    public void shouldCreateContact() {
        contactManager.addContact("Ram", "Dasarwad", "0123456789");
    ...
    public void shouldThrowRuntimeExceptionWhenFirstNameIsNull() {
        Assertions.assertThrows(RuntimeException.class, () -> {
            contactManager.addContact(null, "Dasarwad", "0123456789");
        });
    }
    ...
    public void shouldThrowRuntimeExceptionWhenLastNameIsNull() {
        Assertions.assertThrows(RuntimeException.class, () -> {
            contactManager.addContact("Ram", null, "0123456789");
        });
    }
    ...
    public void shouldThrowRuntimeExceptionWhenPhoneNumberIsNull() {
        Assertions.assertThrows(RuntimeException.class, () -> {
            contactManager.addContact("Ram", "Dasarwad", null);
        });
    }
    ...
    class ParameterizedTests {
        ...
        public void shouldTestPhoneNumberFormatUsingValueSource(String phoneNumber) {
            contactManager.addContact("Ram", "Dasarwad", phoneNumber);
            assertFalse(contactManager.getAllContacts().isEmpty());
            assertEquals(1, contactManager.getAllContacts().size());
        }
